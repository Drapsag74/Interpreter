...
public:
	...
	inline const string & getChaine() const { return m_chaine;} // Accesseur
        inline bool estUneVariable() const { return m_categorie == Symbole::VARIABLE;}
        //inline bool estUnEntier() const {return m_categorie == Symbole::ENTIER;}
        //inline bool estUneChaine() const {return m_categorie == Symbole::CHAINE;}
